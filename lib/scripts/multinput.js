  ...
  (function($, window, document) {
    ...
    MultinputPlugin = (function() {
      ...
      MultinputPlugin.prototype.init = function() {
        ...
        this.pattern = this.$el.data('pattern') != null ? this.$el.data('pattern') : this.$el.attr(this.settings.patternAttribute);
        this.separator = this.$el.data('separator') != null ? this.$el.data('separator') : this.$el.attr(this.settings.separator);
        if (this._validPattern()) {
          this.inputsClasses = this.$el.data('classes') != null ? this.$el.data('classes') : this.settings.inputsClasses;
